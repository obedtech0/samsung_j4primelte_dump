#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/bootdevice/by-name/recovery:18989584:291f32321bd7f0290bae7e8083e8cdd53563e989; then
  applypatch EMMC:/dev/block/bootdevice/by-name/boot:14426640:9dbfc4ba9c29600f761274ccca03e1b43f7db602 EMMC:/dev/block/bootdevice/by-name/recovery 291f32321bd7f0290bae7e8083e8cdd53563e989 18989584 9dbfc4ba9c29600f761274ccca03e1b43f7db602:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
